      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="p-4 border-primary/20 bg-primary/5">
          <div className="text-center space-y-3">
            <div className="text-sm font-medium text-foreground">Ready to play instantly?</div>
            <Button
            ...
            >
              ...
              {isConnecting ? 'Starting...' : 'Quick Start Game'}
            </Button>
            <div className="text-xs text-muted-foreground">
              Instantly join as game host and start playing
            </div>
          </div>
        </Card>
        ...
        <div className="text-center">
          <div className="text-sm text-muted-foreground mb-3">Or customize your experience:</div>
        </div>
